...
def differential_evolution(func, bounds, args=(), strategy='best1bin',
                           ...
                           mutation=(0.5, 1), mutation_callback=None, recombination=0.7, seed=None,
...
class DifferentialEvolutionSolver(object):
    ...
    def __init__(self, func, bounds, args=(),
                 ...
                 tol=0.01, mutation=(0.5, 1),
                 mutation_callback=None, recombination=0.7, seed=None,
    ...
    def __next__(self):
        ...
        if self._updating == 'immediate':
            ...
            for candidate in range(self.num_population_members):
                ...
                if self._mutation_callback is not None and callable(self._mutation_callback):
                    self._mutation_callback(
                        self.func(self._scale_parameters(self.population[candidate])),
    ...
    def _mutate(self, candidate):
        ...
        if strategy in ['currenttobest1exp', 'currenttobest1bin']:
