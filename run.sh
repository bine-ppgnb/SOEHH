...
datasets=("winsconsin_569_32_normalizado" "winsconsin_699_10_normalizado" "winsconsin_198_34_normalizado", "coimbra_116_10_normalizado")
        ...
        do
          ...
          do
            ...
            do
              ...
              echo "Finalizado: ${evolutionary_algorithms[$j]} em: ${datasets[$i]}, iteração: ${o}, fs: ${feature_selection_methods[$k]}, test-size: ${formatted_test_size}"
            done
          done
        done
      done
